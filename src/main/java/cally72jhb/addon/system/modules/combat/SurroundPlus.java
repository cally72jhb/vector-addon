...
public class SurroundPlus extends Module {
    ...
    private final Setting<Boolean> instaPlace = sgGeneral.add(new BoolSetting.Builder()
        .name("insta-place")
        .description("Whether or not to instaplace surround.")
        .defaultValue(false)
        .build()
    );
