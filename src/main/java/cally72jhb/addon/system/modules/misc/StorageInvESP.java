...
public class StorageInvESP extends Module {
    ...
    public StorageInvESP() {
        super(VectorAddon.MISC, "storage-inv-esp", "Shows you the inventory of a storage block.");
    }
    ...
    private void onPreTick(TickEvent.Pre event) {
        if (mc.currentScreen instanceof HandledScreen screen && closeInventory.get() && close) {
            screen.onClose();
    ...
    private void onOpenScreen(OpenScreenEvent event) {
        if (event.screen instanceof HandledScreen<?> screen && closeInventory.get() && close) {
