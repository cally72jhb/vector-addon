...
public class HoleRenderer extends Module {
                ...
                if (hole.isDouble()) {
                    if (ignoreOwn.get() && (mc.player.getBlockPos().equals(hole.pos1) || mc.player.getBlockPos().equals(hole.pos2))
                        ...
                        if (canRender(hole.pos1)
                            && VectorUtils.distanceXZ(mc.player.getPos(), Vec3d.ofCenter(hole.pos1)) <= horizontalDistance.get()
                            && VectorUtils.distanceY(mc.player.getY(), hole.pos1.getY() + 0.5) <= verticalDistance.get()) {
                        ...
                        if (canRender(hole.pos2)
                            && VectorUtils.distanceXZ(mc.player.getPos(), Vec3d.ofCenter(hole.pos2)) <= horizontalDistance.get()
                            && VectorUtils.distanceY(mc.player.getY(), hole.pos2.getY() + 0.5) <= verticalDistance.get()) {
    ...
    public class RenderBlock {
        ...
        public void tick() {
            if (VectorUtils.distanceXZ(mc.player.getPos(), Vec3d.ofCenter(pos)) > horizontalDistance.get()
                || VectorUtils.distanceY(mc.player.getY(), pos.getY() + 0.5) > verticalDistance.get()
        ...
        public boolean isValid() {
            if (!fadeOut.get()
                && (VectorUtils.distanceXZ(mc.player.getPos(), Vec3d.ofCenter(pos)) > horizontalDistance.get()
                || VectorUtils.distanceY(mc.player.getY(), pos.getY() + 0.5) > verticalDistance.get())
