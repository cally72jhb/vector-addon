...
public class VectorStarscript {
    ...
    public static void init() {
        ...
        // General
        ss.set("version", Value.string(Config.get().version.toString()));
        ...
        // Modules
        ss.set("modules", () -> Value.string(Modules.get().getActive().size() + " / " + Modules.get().getCount()));
        ss.set("active_modules", () -> Value.string(Modules.get().getActive().size() + ""));
        ss.set("module_count",   () -> Value.string(Modules.get().getCount() + ""));
        ...
        ss.set("player", Value.map(new ValueMap()
                ...
                .set("pos", Value.map(new ValueMap()
                        .set("_toString", VectorStarscript::playerPosString)
                ...
                .set("get_item", Value.function(VectorStarscript::getItem))
                .set("count_items", Value.function(VectorStarscript::countItems))
        ));

        // Crosshair target
        ss.set("crosshair_target", Value.map(new ValueMap()
                .set("type", VectorStarscript::crosshairType)
                .set("value", VectorStarscript::crosshairValue)
        ));
